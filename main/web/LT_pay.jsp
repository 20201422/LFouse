...
%>
<%
    String lodge_price = request.getParameter("lodge_price");
    session.setAttribute("lodge_price",lodge_price);
    String lodge_limit = request.getParameter("lodge_limit");
    session.setAttribute("lodge_limit",lodge_limit);
    ...
    String lodge_pway = request.getParameter("lodge_pway");
    session.setAttribute("lodge_pway",lodge_pway);
        ...
        <form name=alipayment action="" method=post target="_blank">
            <div id="paybody" style="width: 360px;height: 420px;clear: left;">
                <dl class="content" style="margin-top: 80px">
                    ...
                    <dt>订单名称：</dt>
                    <dd>
                        <input id="WIDsubject" name="WIDsubject" readonly="readonly" value="租赁 <%=h_name%>" />
                    </dd>
                    <hr class="one_line">
                    <dt>付款金额：</dt>
                    <dd>
                        <input id="WIDtotal_amount" name="WIDtotal_amount" readonly="readonly" value="<%=lodge_price%>" />
                    </dd>
                    <hr class="one_line"/>
                    <dt>租赁月数：</dt>
                    <dd>
                        <input id="WIDbody" name="WIDbody" readonly="readonly" value="<%=lodge_limit%> 个月" />
                    </dd>
                    <hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
