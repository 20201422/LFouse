...
<div style="height: 480px;">
    <nav class="LT_menu">
        ...
        <p id="p3"><a href="LT_ShowDataServlet?PageNo=${PageNo}&flag=3">未出租</a></p>
        ...
        <div style="width: 82%;height: 8%;background-color: white;border-radius: 16px;margin-left: 9%;margin-top: 29%;display: flex">
            <div style="margin-left: 31%;line-height: 240%">
                <font style="color: #0597F2">共${YHYS}条记录<font/>
                    ...
                    <a class="abq" href="${pageContext.request.contextPath }/LT_ShowDataServlet?PageNo=1&tiaoshu=2&flag=3">首页</a>
                    <a class="abq" href="${pageContext.request.contextPath }/LT_ShowDataServlet?PageNo=${PageNo-1}&tiaoshu=2&flag=3">上一页</a>
                    <font style="color: #0597F2">${PageNo}/${count}页</font>
                    <a class="abq" href="${pageContext.request.contextPath }/LT_ShowDataServlet?PageNo=${PageNo+1 }&tiaoshu=2&flag=3">下一页</a>
                    <a class="abq" href="${pageContext.request.contextPath }/LT_ShowDataServlet?PageNo=${count }&tiaoshu=2&flag=3">末页</a>
            </div>
        </div>
    </div>
    </div>
